...
const Profile = () =>
{
    ...
    const fetchProfileAndPosts = async () =>
    {
        ...
        try
        {
            ...
            if (!profileId || profileId === 'me') profileId = currentUserId;
            console.log('DEBUG PROFILE', { userId, currentUserId, profileId });
            if (!profileId) throw new Error('No profileId to fetch!');
